...
| 1 | Add `memberConfirmedAt` to admin nudge template params | pending | 0 | phase-01-template-params.md | | | |
| 2 | Build per-member admin keyboard | pending | 1 | phase-02-keyboard.md | | | |
