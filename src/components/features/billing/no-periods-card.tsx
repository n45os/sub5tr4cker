...
export function NoPeriodsCard({ groupId, cycleDay }: NoPeriodsCardProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          A daily cron job creates periods automatically once each cycle has
          started (on or after day {cycleDay}). If you’re before that day or
          the job hasn’t run yet, create the first period manually below.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Button
